...
const testimonials = [
  {
    ...
    company: "Binance",
    content:
      "Как крипто-контентмейкер, я постоянно искала инструмент, который поможет автоматизировать рутину. Этот AI-сервис сканирует все мои кошельки и находит забытые токены, о которых я даже не помнила. Очень удобно и реально экономит время!",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Trezor",
    content:
      "Пробовал несколько крипто-сервисов, но этот — лучший. Он точно определяет остатки на всех моих адресах, включая старые. Даже нашёл токены из тестнета 2021 года. Инструмент на вес золота!",
    categories: [1, 2, 4],
  },
  {
    ...
    content:
      "Раньше проверка баланса по десяткам кошельков была кошмаром. Теперь всё автоматизировано. Этот AI-сервис показывает даже те токены, которые не отображаются в Metamask. Настоящий помощник в мире DeFi!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Ledger",
    content:
      "Качество аналитики от этого крипто-инструмента на высоте. Благодаря нему мы увеличили точность наших отчётов и начали быстрее находить перспективные airdrop'ы. Рекомендую всем, кто в теме.",
    categories: [1, 4],
  },
  {
    ...
    company: "OKX",
    content:
      "Этот сервис буквально спас нашу маркетинговую команду. Мы теперь легко отслеживаем активы клиентов, формируем отчёты и быстро находим забытые токены. Это must-have для агентств, работающих в крипте.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Bybit",
    content:
      "AI-сервис поразил своей универсальностью: он работает с mainnet, тестнетами и даже кастомными токенами. Отличный инструмент для трейдера и криптоаналитика!",
    categories: [1, 3],
  },
  {
    ...
    company: "Crypto.com",
    content:
      "Я был в шоке, насколько просто оказалось найти забытые активы. Буквально за пару минут нашёл токены на старом кошельке, которые сейчас стоят $200+. Крутая технология!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "CoinGecko",
    content:
      "Я не люблю сложные дашборды, поэтому этот AI-инструмент — просто находка. Всё минималистично, понятно и при этом невероятно мощно. Настоящий порядок в моих крипто-активах.",
    categories: [1, 4],
  },
  {
    ...
    company: "BitKeep",
    content:
      "Я далека от технических деталей, но этот сервис мне всё упростил. Не нужно ничего настраивать — просто подключила кошельки, и он сам всё нашёл. Даже токены из старого airdrop'а!",
    categories: [1, 2],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Мы создаём инструменты, которые помогают руководителям выстраивать устойчивую и продуктивную рабочую среду — независимо от того, где находится команда. Решения для тех, кто понимает ценность стабильности и эффективности.
          </p>
        </div>
